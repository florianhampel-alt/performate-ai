...
1. Technique score: X/10
2. Total moves in route: X moves (count all holds from start to top)
3. Hold types visible: [list types]
4. Main improvement: [specific tip]
Answer ALL points with exact numbers."""
        else:
